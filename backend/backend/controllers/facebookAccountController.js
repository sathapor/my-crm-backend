...
exports.addFacebookAccount = async (req, res) => {
  ...
  try {
    ...
    try {
      const subRes = await fetch(`https://graph.facebook.com/v18.0/${page_id}/subscribed_apps?subscribed_fields=messages,messaging_postbacks&access_token=${access_token}`, {
        method: 'POST'
      });
